...
export const getPlannerTasks = async (companyId, clientId, planMonth) => {
    ...
    return tasks.map(task => ({
        ...
        platform: PLATFORM_MAP_BE_TO_FE[task.platform] || task.platform || "Instagram",
        postingDate: task.postingDate ? task.postingDate.toISOString().split("T")[0] : "",
        day: task.day || "",
        contentType: CONTENT_TYPE_MAP_BE_TO_FE[task.contentType] || task.contentType || "Reel",
