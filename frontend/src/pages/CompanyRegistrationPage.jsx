    ...
    <div style={{ minHeight: "100vh", background: "#FAFAFA", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "40px 24px 60px" }}>
        <div style={{ width: "100%", maxWidth: 580 }}>
          ...
          {step === 1 ? (
            <div className="card fade-in" style={{ padding: 32, textAlign: "left" }}>
            ...
            <div className="card fade-in" style={{ padding: 32, textAlign: "left" }}>
              ...
              <div className="grid-2"><FormInput label="Create Password *" type={showPassword ? "text" : "password"} value={admin.password} onChange={e => setA("password", e.target.value)} placeholder="Min. 6 characters" error={errors.password} /><FormInput label="Confirm Password *" type={showPassword ? "text" : "password"} value={admin.confirmPassword} onChange={e => setA("confirmPassword", e.target.value)} placeholder="Re-enter password" error={errors.confirmPassword} /></div>
